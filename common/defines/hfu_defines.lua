...
NDefines.NGame.GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.035, 0.0 } -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDefines.NMilitary.CORPS_COMMANDER_DIVISIONS_CAP = 80
NDefines.NMilitary.FIELD_MARSHAL_DIVISIONS_CAP = 80
